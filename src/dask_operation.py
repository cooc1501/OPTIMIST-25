...
from .aes_intf.aes_inft import init_aes, find_int_values


class DaskOperation:
    # passed on init
    inputs: list[dask.array]

    # allocated after init
    outputs: list[dask.array]
    ...
    def __new__(cls, *args, **kwargs):
        ...
        obj.inputs: list[dask.array] = []
        obj.outputs: list[dask.array] = []
        obj.output_attrs: list[str] = []
        obj._lazy: bool = False if not kwargs.get('lazy') else True
